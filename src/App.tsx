...
export default function App() {
  ...
  const [confidenceStartIndex, setConfidenceStartIndex] = useState(0)
  ...
  function handleNextRound() {
    ...
    setGame(updated)
    setCurrentQuestionPlayerIndex(0)
    setConfidenceStartIndex((confidenceStartIndex + 1) % updated.players.length)
        ...
        <AnimatePresence mode="wait">
          ...
          {screen === 'confidence' && game && (
            <ConfidencePicker
              ...
              startingPlayerIndex={confidenceStartIndex}
